<?php
    class Conexion {
        ...
        */
        ...
        public function __construct($dbhost = '172.19.0.2', $dbuser = 'root', $dbpass = '123', $dbname = 'Intelcost_bienes', $charset = 'utf8') {
            $this->connection = new mysqli($dbhost, $dbuser, $dbpass, $dbname);
            if ($this->connection->connect_error) {
                $this->error('Fallo a conectar con MySQL - ' . $this->connection->connect_error);
            }
        ...
        public function query($query) {
            ...
            if ($this->query = $this->connection->prepare($query)) {
                ...
                $this->error('No se puede preparar la declaración de MySQL (verifique su sintaxis) - ' . $this->connection->error);
            }
            return $this;
        }
